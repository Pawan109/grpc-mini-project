...
type HelloRequest struct {
	...
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` // hum names bhejenge as a req , toh server ko uss name ke liye msg bhejna hai
}
...
type HelloResponse struct {
	...
	Message string `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` //response ke andar msg hoga
}
...
type NamesList struct {
	...
	Names []string `protobuf:"bytes,1,rep,name=names,proto3" json:"names,omitempty"` //?? //NamesList ke andar names honge bht saare
}
...
type MessagesList struct {
	...
	Messages []string `protobuf:"bytes,1,rep,name=messages,proto3" json:"messages,omitempty"` //?? //nessagesList ke andar msgs honge bht saare
}
...
var file_proto_greet_proto_rawDesc = []byte{
	...
	0x47, 0x72, 0x65, 0x65, 0x74, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x40, 0x0a, 0x08,
